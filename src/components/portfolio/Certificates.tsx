    ...
    <section id="certificates" className="section-padding" ref={ref}>
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-2">Certificates & Certications              Achievements</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <motion.div
            ...
            <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">Certificates
